    ...
    companion object HomeTest {
        ...
        fun parameters(): List<Any> {
            return listOf(
                    ...
                    Arguments { arrayOf(AddRecord, Actions.Menu.Garage, Menu(Garage(), false)) },
                    Arguments { arrayOf(AddRecord, Actions.Menu.Home, Menu(Home, false)) },
                    Arguments { arrayOf(AddRecord, Actions.Menu.SignOut, Menu(SignOut, false)) },
